      ...
      <Reveal direction="up">
        <section className="pt-20 pb-10 px-4 flex flex-col items-center text-center">
          ...
          <p className="text-slate-400 max-w-2xl text-lg leading-relaxed">
            A timeline of my career as a full-stack engineer, building
            scalable systems and robust backends for enterprise clients.
          </p>
        </section>
      </Reveal>
          ...
          <Reveal direction="up" delay={0}>
            <div className="glass-card p-6 rounded-xl hover:bg-surface-dark transition-colors border border-border-dark/50">
              ...
              <p className="text-slate-400 text-sm">
                Optimized complex SQL queries and implemented Redis caching
                strategies.
              </p>
            </div>
          </Reveal>
